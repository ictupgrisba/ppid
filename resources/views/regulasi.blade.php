  ...
  <table class="table table-striped" border="0">
    ...
    <tbody>
      <tr>
        ...
        <td ><a href="assets/pdf/UU_No_14_Tahun_2008_0.pdf">View</a></td>
     
      </tr>
      <tr>
      <th>{{$no++ }}</th>
        <td>Peraturan Pemerintah Nomor 61 Tahun 2010 tentang Pelaksanaan Undang-Undang Keterbukaan Informasi Publik</td>
        <td ><a href="assets/pdf/1171325985-PP_61_Tahun_2010.pdf">View</a></td>
      </tr>
      ...
      <th>{{$no++ }}</th>
        ...
        <td ><a href="assets/pdf/Peraturan-Komisi-Informasi-Nomor-4-Tahun-2016.pdf">View</a></td>
      </tr>
      ...
      <th>{{$no++ }}</th>
        ...
        <td ><a href="assets/pdf/Peraturan-Komisi-Informasi-Nomor-5-Tahun-2016.pdf">View</a></td>
      </tr>

      <tr>
      <th>{{$no++ }}</th>
        <td>Peraturan Komisi Informasi Nomor 1 Tahun 2017 Tentang Pengklasifikasian Informasi Publik</td>
        <td ><a href="assets/pdf/Peraturan-Komisi-Informasi-Nomor-1-Tahun-2017.pdf">View</a></td>
      </tr>

      <tr>
      <th>{{$no++ }}</th>
        <td>Peraturan Komisi Informasi Nomor 1 Tahun 2021 Tentang Standar Layanan Informasi Publik</td>
        <td ><a href="assets/pdf/PERKI-1-TAHUN-2021-TENTANG-STANDAR-LAYANAN-INFORMASI-PUBLIK_WEB.pdf">View</a></td>
      </tr>
