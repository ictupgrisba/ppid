...
<html lang="en">
  ...
  <h3 align="center">REGULASI KETERBUKAAN INFORMASI PUBLIK</h3>
  ...
  <table class="table table-striped" border="0">
    ...
    <tbody>
      <tr>
        ...
        <td ><a href="assets/pdf/UU_No_14_Tahun_2008_0.pdf" target="framename">View</a></td>
     
      </tr>
      <tr>
      <th>{{$no++ }}</th>
        <td>Peraturan Pemerintah Nomor 61 Tahun 2010 tentang Pelaksanaan Undang-Undang Keterbukaan Informasi Publik</td>
        <td ><a href="assets/pdf/1171325985-PP_61_Tahun_2010.pdf" target="framename">View</a></td>
      </tr>

      <tr>
      <th>{{$no++ }}</th>
        <td>Peraturan Menteri Pendidikan dan Kebudayaan Republik Indonesia Nomor 41 tahun 2020 tentang Layanan Informasi Publik di Kementerian Pendidikan dan Kebudayaan</td>
        <td ><a href="assets/pdf/SALINAN-Permendikbud-NO-41-TAHUN-2020-TTG-LAYANAN-INFORMASI-PUBLIK.pdf" target="framename">View</a></td>
      </tr>

      <tr>
      <th>{{$no++ }}</th>
        <td>Peraturan Komisi Informasi Nomor 1 Tahun 2012 tentang Tata Tertib Komisi Pusat Republik Indonesia</td>
        <td ><a href="assets/pdf/Peraturan-Komisi-Informasi-Nomor-1-Tahun-2012.pdf" target="framename">View</a></td>
      </tr>

      <tr>
      <th>{{$no++ }}</th>
        <td>Peraturan Komisi Informasi Nomor 1 Tahun 2010 tentang Standar Layanan Informasi Publik</td>
        <td ><a href="assets/pdf/PerKI1-2010InformasiPublik_0.pdf" target="framename">View</a></td>
      </tr>

      <tr>
      <th>{{$no++ }}</th>
        <td>Peraturan Komisi Informasi Nomor 1 Tahun 2013 Tentang Prosedur Penyelesaian Sengketa Informasi Publik</td>
        <td ><a href="assets/pdf/Perki_No.1_Tahun_2013__2.pdf" target="framename">View</a></td>
      </tr>

      <tr>
      <th>{{$no++ }}</th>
        <td>Peraturan Komisi Informasi Nomor 1 Tahun 2016 tentang Mediator Pembantu</td>
        <td ><a href="assets/pdf/Peraturan-Komisi-Informasi-Nomor-1-Tahun-2016.pdf" target="framename">View</a></td>
      </tr>

      <tr>
      <th>{{$no++ }}</th>
        <td>Peraturan Komisi Informasi Nomor 2 Tahun 2016 tentang Tata Cara Pemeriksaan Setempat</td>
        <td ><a href="assets/pdf/Peraturan-Komisi-Informasi-Nomor-2-Tahun-2016.pdf" target="framename">View</a></td>
      </tr>

      <tr>
      <th>{{$no++ }}</th>
        <td>Peraturan Komisi Informasi Nomor 3 Tahun 2016 tentang Kode Etik Anggota Komisi Informasi Pusat</td>
        <td ><a href="assets/pdf/Peraturan-Komisi-Informasi-Nomor-3-Tahun-2016.pdf" target="framename">View</a></td>
      </tr>

      <tr>
      <th>{{$no++ }}</th>
        <td>Peraturan Komisi Informasi Nomor 4 Tahun 2016 tentang Pedoman Pelaksanaan Seleksi dan Penetapan Anggota Komisi Informasi</td>
        <td ><a href="assets/pdf/Peraturan-Komisi-Informasi-Nomor-4-Tahun-2016.pdf" target="framename">View</a></td>
      </tr>

      <tr>
      <th>{{$no++ }}</th>
        <td>Peraturan Komisi Informasi Nomor 5 Tahun 2016 tentang Metode dan Teknik Evaluasi Keterbukaan Informasi Badan Publik</td>
        <td ><a href="assets/pdf/Peraturan-Komisi-Informasi-Nomor-5-Tahun-2016.pdf" target="framename">View</a></td>
      </tr>

      <tr>
      <th>{{$no++ }}</th>
        <td>Peraturan Komisi Informasi Nomor 1 Tahun 2017 Tentang Pengklasifikasian Informasi Publik</td>
        <td ><a href="assets/pdf/Peraturan-Komisi-Informasi-Nomor-1-Tahun-2017.pdf" target="framename">View</a></td>
      </tr>

      <tr>
      <th>{{$no++ }}</th>
        <td>Peraturan Komisi Informasi Nomor 1 Tahun 2021 Tentang Standar Layanan Informasi Publik</td>
        <td ><a href="assets/pdf/PERKI-1-TAHUN-2021-TENTANG-STANDAR-LAYANAN-INFORMASI-PUBLIK_WEB.pdf" target="framename">View</a></td>
      </tr>
