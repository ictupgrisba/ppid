                ...
                <div class="navbar-nav ms-auto mx-xl-auto p-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu rounded">
                            ...
                            <a href="testimonial.html" class="dropdown-item">Informasi yang Disediakan Secara
                                Serta-Merta</a>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu rounded">
                            ...
                            <a href="testimonial.html" class="dropdown-item">Alur dan Prosedur Keberatan Pengajuan Atas
                                Informasi</a>
        ...
        <div class="row">
            <div class="col-md-6 text-center text-md-start">
                <span class="text-light"><a href="#" class="text-secondary"><i
                            class="fas fa-copyright text-secondary me-2"></i> 2023 Universitas PGRI Sumatera Barat</a>, All right reserved.</span>
            </div>
            <div class="col-md-6 text-center text-md-end">
                ...
                <span class="text-light">Designed By<a href="https://htmlcodex.com"
                                                       class="text-secondary">HTML Codex</a> Distributed By <a
