...
<html lang="en">
  ...
  <h1 align="center" class="text-white">LANGKAH-LANGKAH PENGAJUAN KEBERATAN</h1> 
  </div> 
  <div class="container mt-3">
    <p>1. Pemohon dapat menyampaikan pengajuan keberatan dengan datang langsung meja layanan informasi dan mengisi formulir permohonan keberatan dengan melengkapi fotocopy identitas diri 
        (KTP/SIM/Passport) atau mengisi formulir secara online di website PPID </p>
    <p>2. Petugas layanan memproses pengajuan keberatan dan menerima tanda bukti pengajuan keberatan dari petugas layanan informasi </p>
    <p>3. PPID UPGRISBA memberikan informasi atas pengajuan keberatan kepada pemohon, bila pemohon puas maka pengajuan keberatan selesai </p>
    <p>4. Bila pemohon merasa tidak puas atas informasi tersebut maka PPID meneruskan pengajuan keberatan ke Atasan PPID </p>
    <p>5. Atasan PPID memberikan keputusan atau tanggapan atas pengajuan keberatan tersebut paling lambat 30 hari kerja setelah diterimanya keberatan secara tertulis </p>
    <p>6. Jika pemohon merasa tidak puas atas tanggapan dari Atasan PPID, maka penyelesaian Sengketa Informasi Publik dapat diajukan kepada Komisi Informasi</p>
</div>
