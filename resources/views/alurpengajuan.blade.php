...
<html lang="en">
  ...
  <h1 align="center" class="text-white">TATA CARA DAN PROSEDUR PEMOHON INFORMASI PUBLIK MENGAJUKAN
PERMOHONAN SENGKETA INFORMASI PUBLIK KE KOMISI INFORMASI :</h1> 
  </div> 
  <div class="container mt-3">
    <p align="justify">1. Pengajuan sengketa informasi publik ke komisi informasi diajukan pemohon informasi publik selambat-lambatnya 14 HARI KERJA sejak diterimanya tanggapan tertulis atas surat keberatan pemohon informasi publik kepada atasan PPID badan publik atau berakhirnya masa 30 HARI KERJA bagi atasan PPID badan publik untuk memberikan
         tanggapan secara tertulis atas surat keberatan dari pemohon informasi publik</p>
    <p align="justify">2. Pengajuan sengketa informasi publik baik oleh perorangan, badan hukum ataupun kelompok orang bisa diajukan dengan cara mendatangi langsung kantor komisi informasi dan menemui petugas administrasi-pengaduan dan penyelesaian sengketa informasi ataupun mengajukan permohonan sengketa informasi publik secara online kepada komisi informasi melalui aplikasi SIMSI
         (Sistem Informasi dan Manajemen Sengketa Informasi) dengan link url atau alamat website aplikasi http://simsi.komisiinformasi.go.id </p>
    <p align="justify">3. Pemohon sengketa informasi publik wajib melengkapi berkas permohonan pengajuan sengketa informasi publik sebelum mendapatkan nomor registrasi /akta registrasi sengketa informasi publik dari petugas kepaniteraan komisi informasi</p>
    <p align="justify">4. Setelah permohonan sengketa informasi publik mendapatkan nomor registrasi atau akta registrasi maka 14 hari kerja setelahnya komisi informasi mulai melakukan proses penyelesaian sengketa informasi publik dengan di awali melakukan pemanggilan secara patut kepada pemohon dan
         termohon untuk menghadiri sidang ajudikasi non litigasi tahap pemeriksaan awal.</p>
</div>
